  ...
  data = [
    {
      "chart": {
        ...
        "currentStartDate": 1475452800000
      }
    }

  ];
  @ViewChild('chartContainer') container;
  treeData = anychart.data.tree(this.data, "as-tree");


  chart: anychart.charts.Resource = null;


  ngOnInit() {
    // Default data set mapping, hardcoded here.
      // create a chart and set loaded data
      let chart = anychart.resource(this.dataService_.getResData());
